# -*- coding: utf-8 -*-
"""
独立脚本：SMILES → MACCS keys

用法::

    python generators/maccs/generate.py examples/molecules.csv -o output/maccs.csv
"""
