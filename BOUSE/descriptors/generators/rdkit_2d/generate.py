# -*- coding: utf-8 -*-
"""
独立脚本：SMILES → RDKit 2D 描述符

用法::

    python -m generators.rdkit_2d.generate examples/molecules.csv -o output/rdkit.csv
    # 或
    python generators/rdkit_2d/generate.py examples/molecules.csv -o output/rdkit.csv
"""
...
from generators.rdkit_2d.core import compute  # noqa: E402
from io_utils import load_molecule_table, validate_descriptor_frame, write_descriptor_csv  # noqa: E402


def main(argv: list[str] | None = None) -> None:
    p = argparse.ArgumentParser(description="生成 RDKit 2D 描述符")
